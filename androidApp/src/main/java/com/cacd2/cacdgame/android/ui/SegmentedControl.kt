...
fun SegmentedControl(
    ...
    itemWidth: Dp = 120.dp,
    cornerRadius: Int = 10,
    color: Color = if (MaterialTheme.colors.isLight) MaterialTheme.colors.primary else MaterialTheme.colors.onSurface,
...
fun SegmentedControlPreview() {
    AppTheme {
        Surface {
            SegmentedControl(items = listOf("1", "2", "3"), onItemSelection = {})
        }
    }
}
...
@Composable
fun SegmentedControlDarkPreview() {
    AppTheme {
        Surface {
            SegmentedControl(items = listOf("1", "2", "3"), onItemSelection = {})
        }
