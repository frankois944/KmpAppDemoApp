...
fun OnBoardingPage2View(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.onbaording2),
        ...
        Column(
            ...
            Text(
                ...
                annotatedStringResource(
                    id = R.string.onboarding_2_content,
                    styles =
                    mapOf(
                        Typeface.ITALIC to
                            SpanStyle(
...
fun OnBoardingPage2Preview() {
    AppTheme {
        Surface(modifier = Modifier.fillMaxSize()) {
            OnBoardingPage2View(appContext = AppContext(), prevPage = {}, nextPage = {})
        }
    }
}
...
@Composable
fun OnBoardingPage2DarkPreview() {
    AppTheme {
        Surface(modifier = Modifier.fillMaxSize()) {
            OnBoardingPage2View(appContext = AppContext(), prevPage = {}, nextPage = {})
        }
